...
public class ModEntities {
    public static final EntityType<ArmoredOrcEntity> ARMORED_ORC = Registry.register(Registries.ENTITY_TYPE, new Identifier(WorldOfDragonsMain.MOD_ID, "armored_orc"),
            FabricEntityTypeBuilder.create(SpawnGroup.MONSTER, ArmoredOrcEntity::new).dimensions(EntityDimensions.fixed(1.3f, 2.5f)).build());

    public static final EntityType<GoblinEntity> GOBLIN = Registry.register(Registries.ENTITY_TYPE, new Identifier(WorldOfDragonsMain.MOD_ID, "goblin"),
            FabricEntityTypeBuilder.create(SpawnGroup.MONSTER, GoblinEntity::new).dimensions(EntityDimensions.fixed(1.1f, 2.1f)).build());

    public static final EntityType<ArcherOrcEntity> ARCHER_ORC = Registry.register(Registries.ENTITY_TYPE, new Identifier(WorldOfDragonsMain.MOD_ID, "archer_orc"),
            FabricEntityTypeBuilder.create(SpawnGroup.MONSTER, ArcherOrcEntity::new).dimensions(EntityDimensions.fixed(1.3f, 3.3f)).build());

    public static final EntityType<FlyerOrcEntity> FLYER_ORC = Registry.register(Registries.ENTITY_TYPE, new Identifier(WorldOfDragonsMain.MOD_ID, "flyer_orc"),
            FabricEntityTypeBuilder.create(SpawnGroup.MONSTER, FlyerOrcEntity::new).dimensions(EntityDimensions.fixed(1.3f, 2.2f)).build());

    public static final EntityType<OrcBossEntity> ORC_BOSS = Registry.register(Registries.ENTITY_TYPE, new Identifier(WorldOfDragonsMain.MOD_ID, "orc_boss"),
            FabricEntityTypeBuilder.create(SpawnGroup.MONSTER, OrcBossEntity::new).dimensions(EntityDimensions.fixed(1.3f, 2.2f)).build());

    public static final EntityType<OrcBruteEntity> ORC_BRUTE = Registry.register(Registries.ENTITY_TYPE, new Identifier(WorldOfDragonsMain.MOD_ID, "orc_brute"),
            FabricEntityTypeBuilder.create(SpawnGroup.MONSTER, OrcBruteEntity::new).dimensions(EntityDimensions.fixed(2.1f, 3.5f)).build());

    public static final EntityType<SlasherOrcEntity> SLASHER_ORC = Registry.register(Registries.ENTITY_TYPE, new Identifier(WorldOfDragonsMain.MOD_ID, "slasher_orc"),
            FabricEntityTypeBuilder.create(SpawnGroup.MONSTER, SlasherOrcEntity::new).dimensions(EntityDimensions.fixed(1.3f, 3.1f)).build());

    public static final EntityType<OrcMageEntity> ORC_MAGE = Registry.register(Registries.ENTITY_TYPE, new Identifier(WorldOfDragonsMain.MOD_ID, "orc_mage"),
    ...
    public static final EntityType<LavaElementalEntity> LAVA_ELEMENTAL = Registry.register(Registries.ENTITY_TYPE, new Identifier(WorldOfDragonsMain.MOD_ID, "lava_elemental"),
    ...
    public static final EntityType<Sn0wix_NPC> SN0WIX_ = Registry.register(Registries.ENTITY_TYPE, new Identifier(WorldOfDragonsMain.MOD_ID, "sn0wix_"),
            FabricEntityTypeBuilder.create(SpawnGroup.CREATURE, Sn0wix_NPC::new).dimensions(EntityDimensions.fixed(0.6f, 1.8f)).build());

    public static final EntityType<BubbaGump7NPC> BUBBAGUMP7 = Registry.register(Registries.ENTITY_TYPE, new Identifier(WorldOfDragonsMain.MOD_ID, "bubbagump7"),
            FabricEntityTypeBuilder.create(SpawnGroup.CREATURE, BubbaGump7NPC::new).dimensions(EntityDimensions.fixed(0.6f, 1.8f)).build());

    public static final EntityType<BouquetZNPC> BOUQUETZ = Registry.register(Registries.ENTITY_TYPE, new Identifier(WorldOfDragonsMain.MOD_ID, "bouquetz"),
            FabricEntityTypeBuilder.create(SpawnGroup.CREATURE, BouquetZNPC::new).dimensions(EntityDimensions.fixed(0.6f, 1.8f)).build());


    public static final EntityType<ModChestEntity> IRON_CHEST_ENTITY = Registry.register(Registries.ENTITY_TYPE, new Identifier(WorldOfDragonsMain.MOD_ID, "iron_chest"),
            getModChestEntityType((type, world) -> new ModChestEntity(type, world, RawAnimation.begin().thenPlayAndHold("animation.iron_chest.open"),
    ...
    public static void registerModEntities() {
        WorldOfDragonsMain.LOGGER.info("Registering entities for " + WorldOfDragonsMain.MOD_ID);
    }

...
import net.sn0wix_.worldofdragonsmod.util.ParticleSpawnUtil;
...
public class ExplodingCubeProjectile extends ExplosiveProjectileEntity {
    ...
    private void createExplosion() {
        world.createExplosion(this, getDamageSources().create(DamageTypes.EXPLOSION), new NoBlocksDestroyBehavior(), getPos(), 1f, true, World.ExplosionSourceType.BLOCK);
        if (!world.isClient()) {

package net.sn0wix_.worldofdragonsmod.client.renderersAndModels.entity.misc.ironChest;
...
public class ModChestEntityModel extends GeoModel<ModChestEntity> {
    ...
    public ModChestEntityModel(String modelLoc, String texture, String animations) {
        MODEL_RESOURCE = new Identifier(WorldOfDragons.MOD_ID, modelLoc);

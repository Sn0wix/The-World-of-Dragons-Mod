...
public class GoblinModel extends GeoModel<GoblinEntity> {
    public static final Identifier MODEL_RESOURCE = new Identifier(WorldOfDragons.MOD_ID, "geo/goblin.geo.json");
    public static final Identifier TEXTURE_RESOURCE = new Identifier(WorldOfDragons.MOD_ID, "textures/entity/goblin/goblin.png");
    public static final Identifier INFECTED_TEXTURE_RESOURCE = new Identifier(WorldOfDragons.MOD_ID, "textures/entity/goblin/goblin_infected.png");
    public static final Identifier ANIMATION_RESOURCE = new Identifier(WorldOfDragons.MOD_ID, "animations/goblin.animation.json");
